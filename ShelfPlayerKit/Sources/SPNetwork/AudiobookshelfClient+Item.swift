...
internal extension AudiobookshelfClient {
    func item(itemId: String) async throws -> ItemPayload {
        try await request(ClientRequest(path: "api/items/\(itemId)", method: "GET", query: [
...
public extension AudiobookshelfClient {
    func item(itemId: String, episodeId: String?) async throws -> (PlayableItem, [PlayableItem.AudioTrack], [Chapter]) {
