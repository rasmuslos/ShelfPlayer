...
public extension Series {
    static let fixture = Series(
        id: .init(itemID: "fixture", episodeID: nil, libraryID: "fixture", type: .series),
        name: "The Witcher",
        ...
        addedAt: Date(),
        covers: [
            Cover(type: .mock, size: .normal, url: URL(string: "https://m.media-amazon.com/images/I/51r+po1oBdL._SL500_.jpg")!),
            Cover(type: .mock, size: .normal, url: URL(string: "https://m.media-amazon.com/images/I/51r+po1oBdL._SL500_.jpg")!),
            Cover(type: .mock, size: .normal, url: URL(string: "https://m.media-amazon.com/images/I/51r+po1oBdL._SL500_.jpg")!),
            Cover(type: .mock, size: .normal, url: URL(string: "https://m.media-amazon.com/images/I/51r+po1oBdL._SL500_.jpg")!),
            Cover(type: .mock, size: .normal, url: URL(string: "https://m.media-amazon.com/images/I/51r+po1oBdL._SL500_.jpg")!),
