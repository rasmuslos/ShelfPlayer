...
public extension Episode {
    static let fixture = Episode(
        id: .init(itemID: "fixture", episodeID: "fixture", libraryID: "fixture", type: .episode),
        ...
        cover: Cover(type: .mock, size: .normal, url: URL(string: "https://m.media-amazon.com/images/I/319dN5LJ7TL._SL500_.jpg")!),
        addedAt: Date(),
