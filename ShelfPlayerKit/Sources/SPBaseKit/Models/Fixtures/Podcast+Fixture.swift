...
extension Podcast {
    public static let fixture = Podcast(
        id: "fixture",
        additionalId: nil,
        libraryId: "fixture",
        name: "Tagesschau",
        ...
        image: Item.Image.init(
            url: URL(string: "https://yt3.ggpht.com/a/AATXAJzzBYy7X230jcXQOXOOsHRLsEjwMluIvn1IVg%3ds900-c-k-c0xffffffff-no-rj-mo")!,
            type: .remote),
        genres: ["News"],
        addedAt: Date(),
