...
public extension Episode {
    struct EpisodeIndex: Codable, Comparable, Sendable {
        ...
        public static func < (lhs: EpisodeIndex, rhs: EpisodeIndex) -> Bool {
...
public extension Episode {
    enum EpisodeType: Codable, Sendable, CaseIterable, Identifiable {
        case regular
        case trailer
        case bonus
