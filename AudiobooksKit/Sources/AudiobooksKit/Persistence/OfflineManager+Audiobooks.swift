...
extension OfflineManager {
    @MainActor
    public func downloadAudiobook(_ audiobook: Audiobook) async throws {
...
extension OfflineManager {
    ...
    @MainActor
    public func getAllAudiobooks() -> [Audiobook] {
...
extension OfflineManager {
    @MainActor
    public func deleteAudiobook(audiobookId: String) throws {
