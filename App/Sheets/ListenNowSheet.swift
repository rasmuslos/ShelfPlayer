    ...
    var body: some View {
        NavigationStack {
            List {
                ...
                if settings.enableConvenienceDownloads {
                    Section {
                        Toggle("preferences.convenienceDownload.enableListenNowDownloads", systemImage: "arrow.down.square", isOn: $settings.enableListenNowDownloads)
                    }
                }
            }
        }
